...
class TQLearning:  # Implementation of Toll-based Q-Learning
    """
        ...
        This version of the algorithm is decoupled from the Driver Agent of the environment.
    """
    ...
    def update_strategy(self, obs_: tuple, reward: float, info: dict, alpha: float = None) -> None:
        ...
        """
        travel_time = reward
        free_flow_travel_time = info['free_flow_travel_times'][self.__last_action]
