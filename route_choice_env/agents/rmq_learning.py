...
class DriverRMQLearning(DriverAgent):  # Implementation of Driver Agent as a RMQ-Learning
    """
        ...
        This version of the algorithm also implements behavior from the Driver Agent of the environment.
    """
...
class RMQLearning:  # Implementation of Regret Minimisation Q-Learning
    ...
    def __init__(self,
        ...
        # Estimated regret
        self.__estimated_regret = None
        self.__estimated_action_regret = {a: 0.0 for a in self.__actions}
